...
export default function Testimonials() {
  ...
  return (
    ...
    >
      {/* Background blurs */}
      <div className="absolute top-[20%] right-[-15%] w-[40%] h-[40%] bg-gradient-primary opacity-5 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[20%] left-[-15%] w-[40%] h-[40%] bg-gradient-accent opacity-5 blur-[120px] pointer-events-none" />
          ...
          {testimonials.map((t, index) => (
            ...
            >
              ...
              <div className="flex items-center space-x-4 border-t border-border-card/20 pt-6">
                {/* Avatar Icon */}
                <div className="w-10 h-10 rounded-full bg-gradient-primary flex items-center justify-center font-space-grotesk font-bold text-xs text-white shadow-inner">
                  {t.avatarInitials}
                </div>
                <div>
